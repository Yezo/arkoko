          ...
          <div className="basis-4/5 text-[0.825rem] ">
            <span className="flex min-h-[9rem] flex-col justify-center gap-3 rounded-md bg-primary px-5 py-2 tracking-tight  ring-1 ring-black/[.30]">
              <span className="flex items-center gap-2">
                <span className="inline-flex min-w-[3rem] select-none items-center justify-center rounded bg-gradient-to-br from-accent via-green-500 to-green-600 px-2 py-[1px] font-semibold text-primary ring-1 ring-black/[.15]">
                  Lv.1
                </span>
                {ENGRAVING.levelOne}
              </span>
